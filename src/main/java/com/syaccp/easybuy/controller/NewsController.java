...
public class NewsController {
	...
	// public String upload2(@Valid User user,BindingResult
	// errors,MultipartRequest request){
	...
	/*
	 * * @RequestMapping("") public ModelAndView list(HttpServletRequest
	 * request, Integer departurecity, Integer arrivalcity) { ModelAndView view
	 * = new ModelAndView(); List<Flight> list =
	 ...
	 * <property name="prefix" value="/WEB-INF/manage/"></property> <property
